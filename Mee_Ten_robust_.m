...
%     vv = chi2rnd(1,[1, LEN]);
%     vv = trnd(2,[1, LEN]);
%     vv = betarnd(2,5,1, LEN);
%     vv = raylrnd(0.1,1, LEN);
...
h=legend('MEE1 (\eta=2, L=15, {\bf\sigma=0.2})','MEE2 ({\eta=1.8}, L=15, {\bf\sigma=0.4})','MEE3 ({\eta=1.5}, L=15, {\bf\sigma=0.6})','MEE4 ({\eta=1.1}, L=15, {\bf\sigma=0.8})','MMEE-Hample1 ({\eta=0.6},  L=15, {\bf\sigma=0.2}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample2 ({\eta=0.6}, L=15, {\bf\sigma=0.4}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample3 ({\eta=0.4}, L=15, {\bf\sigma=0.6}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample4 ({\eta=0.3}, L=15, {\bf\sigma=0.8}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)');
