...
h=legend('MEE1 (\eta=2.5, L=15, {\bf\sigma=0.5})','MEE2 ({\eta=2}, L=15, {\bf\sigma=1})','MEE3 ({\eta=1}, L=15, {\bf\sigma=1.5})','MEE4 ({\eta=0.8}, L=15, {\bf\sigma=2})','MMEE-Hample1 ({\eta=1},  L=15, {\bf\sigma=0.5}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample2 ({\eta=0.5}, L=15, {\bf\sigma=1}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample3 ({\eta=0.5}, L=15, {\bf\sigma=1.5}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)','MMEE-Hample4 ({\eta=0.6}, L=15, {\bf\sigma=2}, \Delta_1=0.5, \Delta_2=2, \Delta_3=4)');
